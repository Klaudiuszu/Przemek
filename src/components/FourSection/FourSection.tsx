...
const FourSection = () => {
  ...
  const pizzas = [
    { src: "/images/pizza1.png", name: tString("fourSection.pizza1.name"), description: tString("fourSection.pizza1.description"), number: 1 },
    { src: "/images/pizza2.png", name: tString("fourSection.pizza2.name"), description: tString("fourSection.pizza2.description"), number: 2 },
    { src: "/images/pizza3.png", name: tString("fourSection.pizza3.name"), description: tString("fourSection.pizza3.description"), number: 3 },
    { src: "/images/pizza6.png", name: tString("fourSection.pizza6.name"), description: tString("fourSection.pizza6.description"), number: 6 },
    { src: "/images/pizza5.png", name: tString("fourSection.pizza5.name"), description: tString("fourSection.pizza5.description"), number: 5 },
    { src: "/images/pizza4.png", name: tString("fourSection.pizza4.name"), description: tString("fourSection.pizza4.description"), number: 4 },
  ];
