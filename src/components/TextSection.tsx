  ...
  return (
    <section className="lg:py-[240px] py-[64px] max-w-screen-2xl mx-auto flex flex-col" id="about">
      ...
      <motion.div
        ...
        className="flex justify-center"
      >
        <div className="flex flex-col	 lg:grid gap-8 lg:grid-cols-1 items-center py-8 px-4 lg:gap-16 3xl:px-0 lg:px-16">
          <div className="flex justify-center about-me-section-wrapper text-[#171717]">
            <h4 className=" lg:px-0 max-w-4xl sm:px-16 md:text-[24px] text-left mundial-font 3xl:max-w-[967px]">
