...
const WhyUsSection = () => {
  ...
  return (
    <section className="flex justify-center align-center lg:h-lvh lg:py-16 max-w-screen-2xl relative" id="about">
      ...
      >
        <div className="flex flex-col lg:grid gap-8 lg:grid-cols-2 items-center py-8 px-4 lg:gap-16 lg:px-16 about-me-section-wrapper">
