...
const PrivacyPolicyDashboard = () => {
    ...
    return (
        <section className="lg:pb-16 lg:pt-40 pt-30 max-w-screen-xl md:p-20 px-4 xl:px-12 py-12 mt-24 xl:mt-0  mx-auto flex flex-col gap-8 text-white" id="privacyPolicy">
            ...
            <div className="flex gap-2 flex-col">
                <ul className="flex gap-2 flex-col list-outside list-decimal text-xs">
            ...
            <div className="flex gap-2 flex-col">
                <ul className="list-outside list-decimal text-xs">
...
export default PrivacyPolicyDashboard;
