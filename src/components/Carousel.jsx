    ...
    return (
        <div id="gallery" className="relative w-full h-screen xl:h-[1080px]" data-carousel="slide">
            ...
            <button
                ...
                onClick={prevSlide}
            >
                <span className="inline-flex items-center justify-center md:w-[58px] w-10 h-10 md:h-[58px] rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
                    <svg
